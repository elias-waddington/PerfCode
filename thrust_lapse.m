...
figure(1)
plot(tout./tout(1),h_count,tdout./tdout(1),h_count)
xlabel('Thrust Available, Non-dimensionalised')
ylabel('Altitude, Ft')
title('Thrust Lapse Comparison, Sized by Take-Off')
legend('Fuel Cell','Jet Engine','Location','southwest')

figure(2)
plot(pout,h_count,delta,h_count)
xlabel('Power Available, Non-dimensionalised')
ylabel('Altitude, feet')
title('Power Lapse Comparison, Sized by Take-Off')
legend('Fuel Cell','Jet Engine','Location','southwest')
