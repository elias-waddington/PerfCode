...
% AR_sweep = 9;
AR_sweep = linspace(8,11,4);
% S_sweep = 2000;
S_sweep = linspace(1740,1940,3);
sweep14_sweep = 22.422*linspace(.9,1.1,5);%*linspace(.8,1.2,21);
sweep12_sweep =  18.761*linspace(.9,1.1,5);%*linspace(.8,1.2,21);
sweepmct_sweep =  20.686*linspace(.9,1.1,5);%*linspace(.8,1.2,21);
taper_sweep = .2861.*linspace(.9,1.1,5); %*linspace(.8,1.2,21); %[0.9*.2861,.2861,1.1*.2861];
tc_sweep = .09458*linspace(.9,1.1,5);
incid_sweep = linspace(-5,5,5); %this is only the root section
h_sweep = 1.5*linspace(.9,1.1,5);
% add dihedral
...
outputfilename2 = ['output_comparison_par_7aerosweep.xlsx'];
